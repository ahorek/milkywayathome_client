...
lda_bins        = 27      -- number of bins in lamdba direction
lda_lower_range = -33    -- lower range for lambda
...
function get_timestep()
    ...
    if ((evolveTime/t > 150000 or t ~= t) and not timestep_control) then
        --error("Too many timesteps, this will take too long! If on the server this run will be discarded. If you are a developer running locally, enable timestep_control.")
        TooManyTimesteps = 1
        t = evolveTime/4.0
    end
