    ...
    static const MWNamedArg argTable[] =
        {
            ...
            { "useMomentum",   LUA_TBOOLEAN, NULL, FALSE, &ctx.useMomentum           },
            ...
            { "MomentumSigma", LUA_TNUMBER,  NULL, TRUE,  &ctx.MomentumSigma         },
            ...
            { "MomentumCorrect", LUA_TNUMBER, NULL, TRUE,  &ctx.MomentumCorrect       },
